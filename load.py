...
# Save the trained distance model to a file
distance_model_filename = 'linear_regression_distance_model.joblib'
joblib.dump(distance_model, distance_model_filename)
print(f'Distance Model saved as {distance_model_filename}')
...
# Save the trained walking time model to a file
walking_time_model_filename = 'linear_regression_walking_time_model.joblib'
joblib.dump(walking_time_model, walking_time_model_filename)
print(f'Walking Time Model saved as {walking_time_model_filename}')
